...
$CMAKE_EXECUTABLE -G "Ninja Multi-Config" -DCMAKE_TOOLCHAIN_FILE=../dv-aarch64-rb5-toolchain.cmake -DCMAKE_CONFIGURATION_TYPES="MinSizeRel" -DBUILD_TESTS=OFF -DBUILD_SSL=OFF -DBUILD_IPC=OFF ..
